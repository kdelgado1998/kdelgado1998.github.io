                    ...
                    <div className="texto-u">
                        <div className="contenido-nosotros">
                            <div className="imagen">
                                <img src="/public/img/meta-12.jpeg" alt="nosotros" />
                            </div>
                            <div className="texto">
                                <p>Se parte de la familia <span>Meta</span> y crea una mejor comunidad apoyado de valores que te serán útiles no solo para lograr tus metas personales sino también profesionales.</p>
